...
// Database Keys
const DB_KEYS = {
    ALUMNI: 'seduulur_alumni',
    PAYMENTS: 'seduulur_payments',
    AGENDAS: 'seduulur_agendas',
    GALLERY: 'seduulur_gallery',
    ADMINS: 'seduulur_admins'
};

// Default Admins (can support 5+ users)
const DEFAULT_ADMINS = [
    { id: 'admin1', username: 'SEDUULURALUMNI', password: 'alumni123', name: 'Admin Utama', role: 'super_admin' },
...
const DEFAULT_PAYMENTS = [
    { id: 'p1', alumniId: 'a1', name: 'Ahmad Fauzi', amount: 50000, month: 'Januari', year: 2026, paymentDate: '2026-01-05', paymentMethod: 'transfer', status: 'paid', note: '' },
    { id: 'p2', alumniId: 'a2', name: 'Siti Nurhaliza', amount: 50000, month: 'Januari', year: 2026, paymentDate: '2026-01-06', paymentMethod: 'ewallet', status: 'paid', note: '' },
    { id: 'p3', alumniId: 'a3', name: 'Budi Santoso', amount: 50000, month: 'Januari', year: 2026, paymentDate: '2026-01-07', paymentMethod: 'transfer', status: 'paid', note: '' },
    { id: 'p4', alumniId: 'a4', name: 'Dewi Lestari', amount: 50000, month: 'Januari', year: 2026, paymentDate: '2026-01-08', paymentMethod: 'cash', status: 'paid', note: '' },
    { id: 'p5', alumniId: 'a1', amount: 50000, month: 'Februari', year: 2026, paymentDate: '2026-02-05', paymentMethod: 'transfer', status: 'paid', note: '' },
    { id: 'p6', alumniId: 'a2', name: 'Siti Nurhaliza', amount: 50000, month: 'Februari', year: 2026, paymentDate: '2026-02-10', paymentMethod: 'ewallet', status: 'paid', note: '' },
    { id: 'p7', alumniId: 'a3', name: 'Budi Santoso', amount: 50000, month: 'Februari', year: 2026, paymentDate: '2026-02-12', paymentMethod: 'transfer', status: 'paid', note: '' }
];
...
function addData(key, item) {
    ...
    item.id = key.substring(11) + Date.now(); // Generate unique ID
    data.push(item);
    setData(key, data);
    return item;
}
